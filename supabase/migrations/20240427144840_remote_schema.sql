...
CREATE POLICY "All authenticated user all operations" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "All authenticated users all operations" ON "public"."orders" TO "authenticated" USING (true);

CREATE POLICY "Allow authenticated users SELECT" ON "public"."products" USING (true) WITH CHECK (true);
